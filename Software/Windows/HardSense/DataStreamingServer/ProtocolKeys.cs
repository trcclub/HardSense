...
namespace HardSense.DataStreamingServer
{
    class ProtocolKeys
    {
        ...
        public static void init()
        {
            ...
            TRANSMISSION_KEYS.Add("CONFIG_REQUEST_WIFI_DEVICE_ID", '\u003A'); // :
            TRANSMISSION_KEYS.Add("CONFIG_REQUEST_BT_DEVICE_ID", '\u003B'); // ;
            TRANSMISSION_KEYS.Add("CONFIG_CURRENT_WIFI_DEVICE_ID", '\u003C'); // <
            TRANSMISSION_KEYS.Add("CONFIG_CURRENT_BT_DEVICE_ID", '\u003D'); // =
            TRANSMISSION_KEYS.Add("CONFIG_SET_WIFI_DEVICED_ID", '\u003E'); // >
            TRANSMISSION_KEYS.Add("CONFIG_SET_BT_DEVICE_ID", '\u003F'); // ?
            TRANSMISSION_KEYS.Add("CONFIG_WIFI_DEVICE_ID_UPDATE_SUCCESS", '\u0040'); // @
            TRANSMISSION_KEYS.Add("CONFIG_BT_DEVICE_ID_UPDATE_SUCCESS", '\u0041'); // A
