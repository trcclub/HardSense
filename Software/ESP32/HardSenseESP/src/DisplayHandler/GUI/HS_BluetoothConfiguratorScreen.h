...
#define DELETE_CALIB_PANEL_LOW_X 207
#define DELETE_CALIB_PANEL_HIGH_X 320
#define DELETE_CALIB_PANEL_LOW_Y 180
#define DELETE_CALIB_PANEL_HIGH_Y 240
...
private:
	...
	bool Delete_Touch_Calib_Panel_Touched(int x, int y);
public:
